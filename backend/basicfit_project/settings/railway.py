"""
Configuration Railway COMPLÈTE pour l'API Android BasicFit
"""
import os
...
# Database - PostgreSQL Railway ou SQLite local
...
print("Configuration Railway COMPLÈTE (API Android) chargée")
